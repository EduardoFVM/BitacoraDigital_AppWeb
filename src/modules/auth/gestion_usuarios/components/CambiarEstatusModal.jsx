export default function CambiarEstatusModal(){
    return(
         <div className="modal fade" id="cambiarEstatusModal" tabIndex="-1" aria-labelledby="cambiarEstatusModalLabel" aria-hidden="true">
                ...
                <div className="modal-content border-0 shadow" style={{ borderRadius: '12px' }}>
                    ...
                    <div className="modal-header border-0 pb-0 pt-4 px-4 d-flex flex-column align-items-start">
                        <div className="d-flex justify-content-center w-100 mb-1">
                            <h5 className="modal-title fw-bold text-dark" id="nuevoUsuarioModalLabel">¿Cambiar Estatus?</h5>
                        </div>
                    </div>
