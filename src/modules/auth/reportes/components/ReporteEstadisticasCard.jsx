import { Users, FolderKanban, ClipboardCheck, ImageOff, Clock, CircleCheckBig, CircleX, TrendingUp } from "lucide-react";
...
export default function ReporteEstadisticasCard({ item }) {
    if (!item) return null;
